...
function n_window(name, url) {
  new_window(name, url,  0, 0, 0, 0, 1, 1, 1, 1, 1)
}

var P=String.fromCharCode(109,97,105,108,116,111,58); D="amestad.mx";
function dowrite(str, acc) {
